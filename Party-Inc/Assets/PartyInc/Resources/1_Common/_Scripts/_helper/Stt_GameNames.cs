...
namespace PartyInc
{
    public static class Stt_GameNames
    {
        ...
        public const string GAMENAME_ABBREVIATION_RR = "RR";
        public const string GAMENAME_ABBREVIATION_LL = "LL";
        public const string GAMENAME_ABBREVIATION_CC = "CC";
        public const string GAMENAME_ABBREVIATION_AS = "AS";
    }
}
