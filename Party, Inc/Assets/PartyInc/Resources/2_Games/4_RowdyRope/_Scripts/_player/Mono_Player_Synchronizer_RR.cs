...
namespace PartyInc
{
    namespace RR
    {
        ...
        public class Mono_Player_Synchronizer_RR : MonoInt_SnapshotInterpolator<PlayerSync>
        {
            [SerializeField]
            private Mono_Player_Controller_RR _player;
            ...
            void Start()
            {
                if(_player == null)
                {
                    _player = GetComponent<Mono_Player_Controller_RR>();
                }
            }
