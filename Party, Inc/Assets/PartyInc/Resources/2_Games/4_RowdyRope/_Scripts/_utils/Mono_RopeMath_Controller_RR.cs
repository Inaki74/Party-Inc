...
namespace PlayInc
{
    namespace RR
    {
        ...
        /// </summary>
        public class Mono_RopeMath_Controller_RR : MonoBehaviourPun
        {
            ...
            private Mono_LinkMath_Controller_RR[] ropeLinks;
            ...
            void Update()
            {
                ...
                if (gameStarted)
                {
                    if (firstRun)
                    {
                        rotationSpeed = Mng_GameManager_RR.Current.startingSpeed;
                        firstRun = false;
                    }
            ...
            private void OnEnable()
            {
                ...
                startingAngle = Mng_GameManager_RR.Current.startingAngle;
                angle = startingAngle;
                rotationSpeed = 0f;
                InstantiateRope();
            }
            ...
            private void Awake()
            {
                Mng_GameManager_RR.onGameStart += OnGameStart;
            ...
            private void InstantiateRope()
            {
                ...
                float z = 0;
                int i = 0;
                List<Mono_LinkMath_Controller_RR> ropeAux = new List<Mono_LinkMath_Controller_RR>();
                while (z <= distanceStartEnd)
                {
                    ...
                    ropeAux.Add(GO.GetComponent<Mono_LinkMath_Controller_RR>().Init(this, radius, z, i, startingAngle));
