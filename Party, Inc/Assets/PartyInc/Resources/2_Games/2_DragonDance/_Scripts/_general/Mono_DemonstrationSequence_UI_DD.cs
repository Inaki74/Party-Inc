...
namespace PlayInc
{
    namespace DD
    {
        ...
        /// </summary>
        public class Mono_DemonstrationSequence_UI_DD : MonoBehaviourPun
        {
            ...
            private void OnEnable()
            {
                ...
                IndicatorFunctions.EnableIndicators(feedbackIndicators, Mng_GameManager_DD.Current.amountOfMovesThisRound);
                photonView.RPC("RPC_SendEnable", RpcTarget.Others, Mng_GameManager_DD.Current.amountOfMovesThisRound);
